      ...
      >
        <div className="pl-20 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px]">
          ...
          <p className="text-gray-200 hidden md:block">
            Hello! I'm Haider Asghar, having expertise in Search Engine
            Optimization, Blogging. I'm also learning new technologies of Front
            End Development like HTML, CSS, Javascript, Typescript & Next.js.
          </p>
          <div className="flex-col md:flex-row hidden md:flex gap-5">
            <Link
              href="/my-skills"
              className="rounded-[10px] group relative bg-blue-500 hover:bg-blue-800 px-5 py-3 text-lg text-white max-w-[200px]"
            >
              Learn more
            </Link>
            <Link
